import {
  BookmarkFilledIcon, // Books
  AvatarIcon, // Members
  FileTextIcon, // Loans
  ExclamationTriangleIcon, // Overdue
  BookmarkIcon // Reservations
    ...
    <MainLayout>
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          <Heading size="8" className="text-gray-900 dark:text-gray-100">Librarian Dashboard</Heading>
          <Text className="text-gray-600 dark:text-gray-300 text-lg">
            Welcome, Librarian. Here’s your library management panel.
          </Text>
        </div>
        ...
        {stats && stats.overdueBooks > 0 && (
          <Callout.Root color="red" className="border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950">
            <Callout.Text className="text-red-700 dark:text-red-200">
              <strong>Attention:</strong> There are {stats.overdueBooks} overdue book(s) that need attention.
            </Callout.Text>
          </Callout.Root>
        )}
        ...
        <section>
          ...
          <Grid columns={{ initial: "1", md: "2", lg: "2" }} gap="4">
        ...
        {/* Future features for librarians can be added here */}
      </div>
    </MainLayout>
  );
}